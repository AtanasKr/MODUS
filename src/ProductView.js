...
let prodObj = {
    "Chair1":{info:"Стол",text:"Описание", pic:chair1, price:"127.99лв"},
    "Chair2":{info:"Стол",text:"Описание", pic:chair2, price:"50.99лв"},
    "Chair3":{info:"Стол",text:"Описание", pic:chair3, price:"23.99лв"},
    "Chair4":{info:"Стол",text:"Описание", pic:chair4, price:"99.99лв"},
    "Chair5":{info:"Стол",text:"Описание", pic:chair5, price:"20.99лв"},
    "Chair6":{info:"Стол",text:"Описание", pic:chair6, price:"21.99лв"},
    "Table1":{info:"Маса",text:"Описание", pic:table1, price:"149.99лв"},
    "Table2":{info:"Маса",text:"Описание", pic:table2, price:"199.99лв"},
    "Table3":{info:"Маса",text:"Описание", pic:table3, price:"29.99лв"},
    "Sofa1":{info:"Диван",text:"Описание", pic:sofa1, price:"309.99лв"},
    "Sofa2":{info:"Диван",text:"Описание", pic:sofa2, price:"400"},
    "Sofa3":{info:"Диван",text:"Описание", pic:sofa3, price:"999.99лв"},
    "Sofa4":{info:"Диван",text:"Описание", pic:sofa4, price:"1299.99лв"},
    "Sofa5":{info:"Диван",text:"Описание", pic:sofa5, price:"899.99лв"},
    "Sofa6":{info:"Диван",text:"Описание", pic:sofa6, price:"799.99лв"},
    "Sofa7":{info:"Диван",text:"Описание", pic:sofa7, price:"699.99лв"}
}
    ...
    const userRef = ref(database, 'users');
        onValue(userRef, (snapshot) => {
            ...
            data.forEach(function(childSnapshot){
                const productRef = ref(database, 'productHolder/' + childSnapshot.key + "-product");
                ...
                updates['productHolder/' + childSnapshot.key + "-product/" + newPostKey] = productData;
                // Get the unique ID generated by push() by accessing its key
                alert("Product Send Succesfully!")
